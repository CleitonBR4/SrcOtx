...
class Game
{
	public:
		...
		Item* findItemOfTypeByRange(Cylinder* cylinder, uint16_t itemId,
		...
		void addMagicEffect(const Position& pos, const uint16_t& effect, Creature* sender = nullptr);
		void addMagicEffect(const SpectatorVec& list, const Position& pos, const uint16_t& effect, Creature* sender = nullptr);
#else
		void addMagicEffect(const Position& pos, const uint8_t& effect, Creature* sender = nullptr);
		void addMagicEffect(const SpectatorVec& list, const Position& pos, const uint8_t& effect, Creature* sender = nullptr);
#endif
