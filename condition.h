...
class Condition
{
	...
	protected:
		...
		uint16_t auraEffect; // <-- guarda o id do efeito SISTEMA AURA
		int32_t auraTicks;   // <-- SISTEMA AURA
		int32_t auraInterval; // <-- NOVO: Guarda o tempo customizado
		int32_t auraOffsetX;  // <-- NOVO: Guarda o ajuste no eixo X
		int32_t auraOffsetY;  // <-- NOVO: Guarda o ajuste no eixo Y
};
