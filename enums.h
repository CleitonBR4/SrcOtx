...
enum ConditionParam_t
{
	...
	CONDITIONPARAM_AURA,		// <-- Efeito da aura
	CONDITIONPARAM_AURA_TICKS, // <-- Controla a velocidade (frequência) da Aura
	CONDITIONPARAM_AURA_X,     // <-- Ajusta a posição Horizontal (Direita/Esquerda)
	CONDITIONPARAM_AURA_Y      // <-- Ajusta a posição Vertical (Cima/Baixo)
};
