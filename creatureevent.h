...
class CreatureEvent : public Event
{
	public:
		...
		const std::string& getAutoRegister() const {return m_autoRegister;}
		...
		void executeDeath(Creature* creature, Item* corpse, DeathList deathList);
