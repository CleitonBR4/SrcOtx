...
class LuaInterface
{
	...
	protected:
		...
		static int32_t luaDoPlayerSendStats(lua_State* L);
		// Reset System
		static int32_t luaGetPlayerResets(lua_State* L);
		static int32_t luaSetPlayerResets(lua_State* L);
		static int32_t luaGetPlayerHpBonus(lua_State* L);
		static int32_t luaSetPlayerHpBonus(lua_State* L);
		static int32_t luaGetPlayerMpBonus(lua_State* L);
		static int32_t luaSetPlayerMpBonus(lua_State* L);
		static int32_t luaDoPlayerResetLevel(lua_State* L);
		static int32_t luaGetPlayerRPoints(lua_State* L);
		static int32_t luaSetPlayerRPoints(lua_State* L);
		...
		static int32_t luaErasePlayerAutoLootList(lua_State* L);
		static int32_t luaRemovePlayerAutoLootItem(lua_State* L);
		static int32_t luaAddPlayerAutoLootItem(lua_State* L);
		static int32_t luaGetContainerFreeSlots(lua_State* L);
		static int32_t luaDoCloneItem(lua_State* L);
